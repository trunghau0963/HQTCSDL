...
const DeleteServiceIndicators = ({
  ...
  console.log("DeleteServiceIndicators ", listIdInvoice);
  return (
    <StaffPage>
      <div>
                  ...
                  <div class="card" style="border-radius: 15px;">
                    <div class="card-body p-5">
                      <h2 class="text-uppercase text-center mb-5">
                        Delete Service Indicators
                      </h2>
                      <form
                        id="delete-service-indicators-form"
                        hx-post="/staff/invoice/delete-service-indicators"
                      >
                        ...
                        <div class="d-flex justify-content-center">
                          <button
                            type="submit"
                            hx-target="#delete-service-indicators-form"
                            hx-swap="outerHTML"
...
export default DeleteServiceIndicators;
