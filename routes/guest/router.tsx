...
guestRouter.get("/", async (req, res) => {
  ...
  return res.send(
    <LandingPage>
      <HomeComponent listDentist={listDentist} listService={listService} role={""} />
    </LandingPage>
  );
});
...
guestRouter.get("/dentist-schedule", async (req, res) => {
  ...
  if (schedules.length === 0) return res.send("No schedule is registered!");
  const htmlContent = () => {
    return `
    <div class="accordion accordion-flush" id="accordionAddAppointmentForGuest">
                ...
                <div class="row">
                  <div class="col-6 form-outline mb-4">
                    ...
                    <input
                      ...
                      name="doa"
                      placeholder={data.NGAYKHAM.toISOString().split("T")[0]}
                      readonly="true"
                    />
                  </div>
                  <div class="col-6 form-outline mb-4">
